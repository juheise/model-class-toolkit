...
from model_decorators.argument_validation.arg_inspection import get_default_value
from model_decorators.argument_validation.decorators import required_args
...
def test_get_default_value_multiple_args():
    ...
    assert get_default_value(1, argspec) == "ONE"
...
def test_get_default_value_single_arg():
    ...
    argspec = inspect.getfullargspec(op)
    assert get_default_value(0, argspec) == "ONE"
...
def test_get_default_value_no_default():
    ...
    argspec = inspect.getfullargspec(op)
    assert get_default_value(1, argspec) is None
